...
class Ofertas(models.Model):
    ...
    descOfer = models.CharField(max_length=500,null=True,blank=True,verbose_name='Descripción Oferta')
    skillOfer = models.CharField(max_length=500,null=True, blank=True, verbose_name='Requerimientos')
